...
- [x] Use the Wave AIM browser extension to run an accessibility audit on your completed solutions.
  - 01 had a "warning" : "Skipped heading level" because it went from h1 to h5. However, I did not address this warning because then the text sizes would be different and not look like the image in the instructions.
  - 02: No errors and no alerts to address
  - 03: No errors and no alerts to address
